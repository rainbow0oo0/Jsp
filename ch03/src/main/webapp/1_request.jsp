...
<html>
	<head>
		...
		<%-- 
			...
			GET 요청
			 - 기본 데이터 전송 방식, 전통 데이터를 쿼리스트링으로 전송(URL주소에 붙여 전송)
	...
	<body>
		...
		<p>
			헤더정보 #1 : <%= request.getHeader("User-Agernt") %><br/>
			헤더정보 #2 : <%= request.getHeader("referer") %><br/> <!-- 현재 머무르고 있는 페이지 직전의 요청페이지(이전 페이지) -->
