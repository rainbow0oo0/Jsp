	...
	<head>
		...
		<!--
			...
			JSP 이메일 전송 의존성(라이브러리)
			 - javax.mail-1.6.2jar : 메일 전송에 필요한 기능 제공
			 - activation-1.1.1jar : javax.mail-1.6.2.jar가 필요로 하는 의존 라이브러리
			 
			Gmail SMTP 앱 비밀번호 생성
			 - Gmail > 계정 관리 > 보안 > 2차 인증 > 2단계 인증 사용 설정
			 - Gmail > 계정 관리 > 보안 > 앱 비밀번호 검색 > 앱 비밀번호 생성 후 생성 코드 Session 비번 설정
